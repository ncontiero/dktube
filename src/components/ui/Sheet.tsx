...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      className={cn(
        `
          fixed inset-0 z-99999 bg-black/80 data-[state=closed]:animate-out data-[state=closed]:fade-out-0
...
const sheetVariants = cva(
  `
    fixed z-99999 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:animate-out
